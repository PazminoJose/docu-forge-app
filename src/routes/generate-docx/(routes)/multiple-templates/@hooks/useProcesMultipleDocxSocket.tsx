...
import type { GenerateMultipleDocxSchema } from "../@components/GenerateMultipleDocx/generateMultipleDocxSchema";

export default function useProcessMultipleDocxSocket() {
